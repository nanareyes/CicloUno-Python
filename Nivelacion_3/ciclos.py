...
# Muestre de 2 en 2
# for x in range(1,21,2):#Dónde inicia y dónde termina y variar avance
#     print(x,end='-')

for _ in range(5):
    print(
        "Hola Tripulantes"
    )  # cuando no me interesa la variable pero quiero que algo se ejecute varias veces
...
while trabajando:
    ...
    if input("Desea salir (s)").lower() == "s":  # El lower es para llevar a minúscula
        trabajando = False
